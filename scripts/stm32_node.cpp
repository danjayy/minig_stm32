 ...
 */
 ...
 #include "cola2_msgs/Intensitylightcamfrequency.h"
...
//  #include <rclcpp/rclcpp.hpp>
 ...
 public:
   ...
   bool handle_cam_trigger(cola2_msgs::Intensitylightcamfrequency::Request &request,
                          cola2_msgs::Intensitylightcamfrequency::Response &response);
 ...
 bool STM32node::handle_cam_trigger(cola2_msgs::Intensitylightcamfrequency::Request &request,
                                   cola2_msgs::Intensitylightcamfrequency::Response &response)
 {
 ...
 int main(int argc, char **argv){
  ...
  std::cout << "hii i am here" << std::endl; 
